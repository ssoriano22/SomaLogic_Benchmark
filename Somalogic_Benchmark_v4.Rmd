...
# overlap_SomatoSeer = sscombo_KMC_protID_overlap %>% dplyr::select(c("MUS_UniProt","HOM_UniProt"))
# overlap_SeertoSoma = seer_sscombo_KMC_protein_overlap %>% dplyr::select(c("MUS_UniProt","HOM_UniProt"))
# overlap_method_diff = dplyr::setdiff(overlap_SomatoSeer,overlap_SeertoSoma)
overlap_method_diff2 = merge(sscombo_KMC_protID_overlap,seer_sscombo_KMC_protein_overlap, by = "MUS_UniProt", all = TRUE)
