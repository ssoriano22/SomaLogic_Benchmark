...
annotate_figure(fig_eLoDFilt_AptCount, top = text_grob("Aptamer Count per Sample", size = 16))
...
annotate_figure(fig_Combo_CVplots, top = text_grob("Aptamer CV Distribution per Condition", size = 16))
...
WiT_boxDS_mouse_plot = WiT_boxDS_mouse_df %>%
  ...
  labs(title = "Fold Change (FC) Distribution per Dilution Comparison: Mouse",
       subtitle = "",
       y = "Log2(FC)") +
  theme_bw() +
  #stat_mean_sd_text(size = 2, y.pos = 6000) +
  ...
  theme(axis.title = element_text(vjust = 0.5, size = 10)) +
  theme(title = element_text(size = 12))
ggsave("WiT_boxDS_mouse_plot.png", width = 6, height = 4.51, units = "in")
...
WiT_DE3_mouse_volcano_plot = WiT_DE3_mouse_df %>%
  ...
  geom_text_repel(aes(label = proteins_sig), max.overlaps = 20) +
  scale_color_manual(values = c("black", "red")) +
  labs(title = "Volcano Plot: KMC-PDAC v. KMC Control (Mouse)",
...
WiT_boxDS_human_plot = WiT_boxDS_human_df %>%
  ...
  geom_boxplot(alpha = 0.5) +
  #geom_text(aes(label = median(FC))) +
  labs(title = "Fold Change (FC) Distribution per Dilution Comparison: Human",
       subtitle = "",
       y = "Log2(FC)") +
  theme_bw() +
  #stat_mean_sd_text(size = 2, y.pos = 6000) +
  ...
  theme(legend.title = element_text(size = 10)) +
  theme(title = element_text(size = 12))
ggsave("WiT_boxDS_human_plot.png", width = 6.2, height = 4.51, units = "in")
