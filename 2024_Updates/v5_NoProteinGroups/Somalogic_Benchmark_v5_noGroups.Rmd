...
write.table(corr_mag_plot_df,"corr_mag_NP2_MurPDAC_P7_AK_1_PL_medhighQ_plot.tsv")
...
corr_Log2Intensity_KMCCTRL_NP2_mhQ_MurPDAC_P7_AK_1_PL_plot = corr_mag_plot_df %>%
  ...
  theme(title = element_text(size = 14)) +
  theme(legend.position = "none")
ggsave("Murine_RawData_Graphs/corr_noGroups_Log2Intensity_KMCCTRL_NP2_mhQ_MurPDAC_P7_AK_1_PL_plot.png", width = 7.29, height = 4.51, units = "in")
...
corr_Log2Zscore_KMCCTRL_NP2_mhQ_MurPDAC_P7_AK_1_PL_plot = corr_mag_plot_df %>%
  ...
  labs(title = "SomaLogic vs. Seer Log2 ZScore Intensity",
       subtitle = "KMC_control,MurPDAC_P7_AK_1_PL,NP2,Q:Med+High",
       x = "Soma ZScore Intensity",
       y = "Seer ZScore Intensity") +
  theme_bw() +
  theme(axis.title = element_text(vjust = 0.5, size = 12)) +
  ...
  theme(title = element_text(size = 14)) +
  theme(legend.position = "none")
ggsave("Murine_RawData_Graphs/corr_noGroups_Log2Zscore_KMCCTRL_NP2_mhQ_MurPDAC_P7_AK_1_PL_plot.png", width = 7.29, height = 4.51, units = "in")
...
mag_Log2Intensity_KMCCTRL_NP2_mhQ_MurPDAC_P7_AK_1_PL_plot = corr_mag_plot_df %>%
  ...
  theme(legend.title = element_text(size = 12)) +
  theme(title = element_text(size = 14))
ggsave("Murine_RawData_Graphs/mag_noGroups_Log2Intensity_KMCCTRL_NP2_mhQ_MurPDAC_P7_AK_1_PL_plot.png", width = 18, height = 4.51, units = "in")
...
mag_ZScore_KMCCTRL_NP2_mhQ_MurPDAC_P7_AK_1_PL_plot = corr_mag_plot_df %>%
  ...
  labs(title = "Log2 ZScore Intensity Comparison: SomaLogic vs. Seer",
       subtitle = "KMC - CTRL,MurPDAC_P7_AK_1_PL,NP2,Q:Med+High",
       x = "Protein IDs (UniProt_MUS_HOM)",
       y = "ZScore",
       colour = "Platform") +
  theme_bw() +
  ...
  theme(legend.title = element_text(size = 12)) +
  theme(title = element_text(size = 14))
ggsave("Murine_RawData_Graphs/mag_noGroups_ZScore_KMCCTRL_NP2_mhQ_MurPDAC_P7_AK_1_PL_plot.png", width = 18, height = 4.51, units = "in")
...
corr_Log2Intensity_HumanCase_NP2_RDY0016_04_plot = corr_mag_human_plot_df %>%
  ...
  geom_smooth(method = lm, linetype = "dashed", color = "darkblue", fill = "lightblue2") +
  geom_text_repel(aes(x = Soma_Log2_Intensity, y = Seer_Log2_Intensity, label = UniProt), max.overlaps = 20, size = 2) +
  labs(title = "SomaLogic vs. Seer Log2 Intensity",
  ...
  theme(title = element_text(size = 14)) +
  theme(legend.position = "none")
ggsave("HumanCC_RawData_Graphs/corr_noGroups_Log2Intensity_HumanCC_NP2_RDY0016_04_plot.png", width = 7.29, height = 4.51, units = "in")
...
corr_Log2Zscore_HumanCase_NP2_RDY0016_04_plot = corr_mag_human_plot_df %>%
  ...
  geom_point(aes(color = UniProt), size = 2, alpha = 0.5) +
  geom_smooth(method = lm, linetype = "dashed", color = "darkblue", fill = "lightblue2") +
  geom_text_repel(aes(x = Soma_Log2_ZScore_Intensity, y = Seer_Log2_ZScore_Intensity, label = UniProt), max.overlaps = 20, size = 2) +
  labs(title = "SomaLogic vs. Seer Log2 Zscore Intensity",
       subtitle = "Human Case,RDY0016_04,NP2",
       x = "Soma_Log2_Zscore_Intensity",
       y = "Seer_Log2_Zscore_Intensity") +
  theme_bw() +
  theme(axis.title = element_text(vjust = 0.5, size = 12)) +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgrey") +
  geom_vline(xintercept = 0, linetype = "dashed", color = "darkgrey") +
  theme(title = element_text(size = 14)) +
  theme(legend.position = "none")
ggsave("HumanCC_RawData_Graphs/corr_noGroups_Log2Zscore_HumanCC_NP2_RDY0016_04_plot.png", width = 7.29, height = 4.51, units = "in")
...
mag_Log2Intensity_HumanCase_NP2_RDY0016_04_plot = corr_mag_human_plot_df %>%
  ...
  theme(legend.title = element_text(size = 12)) +
  theme(title = element_text(size = 14))
ggsave("HumanCC_RawData_Graphs/mag_noGroups_Log2Intensity_HumanCC_NP2_RDY0016_04_plot.png", width = 7.29, height = 4.51, units = "in")
...
mag_Log2ZScore_HumanCase_NP2_RDY0016_04_plot = corr_mag_human_plot_df %>%
  ...
  theme(legend.title = element_text(size = 12)) +
  theme(title = element_text(size = 14))
ggsave("HumanCC_RawData_Graphs/mag_noGroups_Log2ZScore_HumanCC_NP2_RDY0016_04_plot.png", width = 7.29, height = 4.51, units = "in")
...
murine_Log2Intensity_hist_plot = raw_sscombo_KMC %>%
  ...
  theme_bw() +
  theme(plot.subtitle = element_text(face = "italic"))
ggsave("murine_Log2Intensity_hist_noGroups_plot.png", width = 7.29, height = 4.51, units = "in")
...
murine_Log2ZScore_hist_plot = raw_sscombo_KMC %>%
  ...
  theme_bw() +
  theme(plot.subtitle = element_text(face = "italic"))
ggsave("murine_Log2ZScore_hist_noGroups_plot.png", width = 7.29, height = 4.51, units = "in")
...
human_Log2Intensity_hist_plot = raw_sscombo_human %>%
  ...
  theme_bw() +
  theme(plot.subtitle = element_text(face = "italic"))
ggsave("human_Log2Intensity_hist_noGroups_plot.png", width = 7.29, height = 4.51, units = "in")
...
human_Log2ZScore_hist_plot = raw_sscombo_human %>%
  ...
  theme_bw() +
  theme(plot.subtitle = element_text(face = "italic"))
ggsave("human_Log2ZScore_hist_noGroups_plot.png", width = 7.29, height = 4.51, units = "in")
...
#Create kable table
knitr::kable(table_numProteins_final_df, col.names = c("Study","Seer Protein Count Initial","Seer Protein Count 50% Sparsity","Seer Protein Count w/o Protein Groups","SomaLogic Protein Count (pre-eLoD)","SomaLogic Protein Count (post-eLoD)","Overlap Protein Count"))
